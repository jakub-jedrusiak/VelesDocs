...
The main way to host Veles surveys is through [VelesWeb](https://velesweb-bcc5f6eb1df3.herokuapp.com/). Currently in closed alpha. Self-hosting is also possible.

## VelesWeb

When you generate a Survey, you get a folder with a series of files. Their structure is not that important if you intent to use [VelesWeb](https://velesweb-bcc5f6eb1df3.herokuapp.com/). The only file that will be interesting, is the archive with `.tar.gz` extension.
