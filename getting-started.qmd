...
We save our items and answers in variables and treat them with `split()`. In here I've done it inside the `questionnaire()` function, but I also could have done it anywhere before that. To learn more about Python string methods, see [W3Schools lesson](https://www.w3schools.com/python/python_ref_string.asp) about them.
