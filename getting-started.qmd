...
Building a website for the first time might take a few minutes due to `npm` downloading or updating JavaScript dependencies. When the dependencies have been downloaded, the whole process gets much faster. The structure of the generated files and what to do with them is explained in Hosting section [below](#sec-hosting).
